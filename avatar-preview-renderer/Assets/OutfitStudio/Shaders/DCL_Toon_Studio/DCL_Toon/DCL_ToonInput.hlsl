...
// Studio-only promotions (rim/GI/bump unlocked as per-material properties; constants in the package shader)
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float, _RimLight)
    UNITY_DOTS_INSTANCED_PROP(float, _RimLight_Power)
    UNITY_DOTS_INSTANCED_PROP(float, _RimLight_InsideMask)
    UNITY_DOTS_INSTANCED_PROP(float, _RimLight_FeatherOff)
    UNITY_DOTS_INSTANCED_PROP(float, _Is_LightColor_RimLight)
    UNITY_DOTS_INSTANCED_PROP(float, _Tweak_RimLightMaskLevel)
    UNITY_DOTS_INSTANCED_PROP(float, _GI_Intensity)
...
static float unity_DOTS_Sampled_RimLight;
static float unity_DOTS_Sampled_RimLight_Power;
static float unity_DOTS_Sampled_RimLight_InsideMask;
static float unity_DOTS_Sampled_RimLight_FeatherOff;
static float unity_DOTS_Sampled_Is_LightColor_RimLight;
static float unity_DOTS_Sampled_Tweak_RimLightMaskLevel;
static float unity_DOTS_Sampled_GI_Intensity;
...
void SetupDOTSToonMaterialPropertyCaches()
{
    ...
    unity_DOTS_Sampled_RimLight 					= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _RimLight);
    unity_DOTS_Sampled_RimLight_Power 				= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _RimLight_Power);
    unity_DOTS_Sampled_RimLight_InsideMask 			= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _RimLight_InsideMask);
    unity_DOTS_Sampled_RimLight_FeatherOff 			= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _RimLight_FeatherOff);
    unity_DOTS_Sampled_Is_LightColor_RimLight 		= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _Is_LightColor_RimLight);
    unity_DOTS_Sampled_Tweak_RimLightMaskLevel 		= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _Tweak_RimLightMaskLevel);
    unity_DOTS_Sampled_GI_Intensity 				= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _GI_Intensity);
...
#define _RimLight                           unity_DOTS_Sampled_RimLight
#define _RimLight_Power                     unity_DOTS_Sampled_RimLight_Power
#define _RimLight_InsideMask                unity_DOTS_Sampled_RimLight_InsideMask
#define _RimLight_FeatherOff                unity_DOTS_Sampled_RimLight_FeatherOff
#define _Is_LightColor_RimLight             unity_DOTS_Sampled_Is_LightColor_RimLight
#define _Tweak_RimLightMaskLevel            unity_DOTS_Sampled_Tweak_RimLightMaskLevel
#define _GI_Intensity                       unity_DOTS_Sampled_GI_Intensity
