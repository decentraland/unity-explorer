...
namespace Preview
{
    ...
    public class PreviewUIPresenter : MonoBehaviour
    {
        ...
        // Debug URL presets, also consumed by the Outfit Studio editor window's Debug tab
        // @formatter:off
        public static readonly List<(string name, string url)> DEBUG_URL_PRESETS = new()
        {
            ("From URL", null),
        ...
        private void EnableDebug()
        {
            ...
            var dropdownOptions = DEBUG_URL_PRESETS;
