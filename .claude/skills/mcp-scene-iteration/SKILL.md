...
- No MCP tool clicks scene entities yet. To test pointer-driven behavior, temporarily force the post-click state in code (e.g. start a door open), verify via screenshot/colliders, then revert.
