...
namespace DCL.Rendering.RenderGraphs.RenderFeatures.Ocean
{
    public partial class MaterialUI : ShaderGUI
    {
        ...
        private RendererFeature_Ocean renderFeature;
        ...
        private void DrawGeneral()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(generalSection.anim.faded))
            {
                ...
                UI.DrawNotification(OceanObject.CustomTime > 0, $"Shader animations are driven by a custom time value set through script ({OceanObject.CustomTime}).", MessageType.Info);
