...
namespace WebGLSupport
{
    ...
    {
        private const string MenuPath = "Assets/WebGLSupport/OverwriteFullscreenButton";

#if UNITY_2021_1_OR_NEWER
        private static readonly bool supportedPostprocessor = true;
        private static readonly string defaultFullscreenFunc = "unityInstance.SetFullscreen(1);";
        private static readonly string fullscreenNode = "unity-container";
#else
        ...
        public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject)
        {
            ...
            string path = Path.Combine(pathToBuiltProject, "index.html");
