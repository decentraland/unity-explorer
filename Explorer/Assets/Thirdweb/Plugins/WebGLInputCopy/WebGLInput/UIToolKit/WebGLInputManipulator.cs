...
namespace WebGLSupport
{
    public class WebGLInputManipulator : Manipulator
    {
        ...
        private readonly bool showHtmlElement;
        ...
        protected override void RegisterCallbacksOnTarget()
        {
            ...
            {
                VisualElement textInput = target.Q("unity-text-input");
        ...
        private void OnFocusInEvent(FocusInEvent evt)
        {
            ...
            WebGLUIToolkitTextField uitoolkit = go.AddComponent<WebGLUIToolkitTextField>();
            uitoolkit.TextField = target as TextField;

            // add WebGLInput to handle the event!
            WebGLInput webglInput = go.AddComponent<WebGLInput>();
