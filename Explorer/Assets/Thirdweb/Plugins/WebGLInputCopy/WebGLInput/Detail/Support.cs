...
namespace WebGLSupport.Detail
{
    public static class Support
    {
        ...
        public static Rect GetScreenCoordinates(RectTransform uiElement)
        {
            ...
            bool useCamera = canvas.renderMode != RenderMode.ScreenSpaceOverlay;
            ...
            if (canvas && useCamera)
            {
                ...
                for (var i = 0; i < worldCorners.Length; i++) { worldCorners[i] = camera.WorldToScreenPoint(worldCorners[i]); }
            }
