    ...
    public struct ComponentsContainer
    {
        ...
        public static ComponentsContainer Create()
        {
            ...
            sdkComponentsRegistry
               ...
               .Add(SDKComponentBuilder<PBPlayerInputMovement>.Create(ComponentID.PLAYER_INPUT_MOVEMENT).AsProtobufResult())
               //.Add(SDKComponentBuilder<PBAvatarFreezeMovement>.Create(ComponentID.AVATAR_FREEZE_MOVEMENT).AsProtobufResult())
                ;
