    ...
    public class DynamicWorldContainer : DCLWorldContainer<DynamicWorldSettings>
    {
            ...
            CancellationToken ct)
        {
            ...
            var globalPlugins = new List<IDCLGlobalPlugin>
            {
                ...
                new NftPromptPlugin(assetsProvisioner, webBrowser, container.MvcManager, nftInfoAPIClient, staticContainer.WebRequestsContainer.WebRequestController, staticContainer.WebRequestsContainer.GetTextureArgsFactory, dclCursor),
                ...
                new NotificationPlugin(
                    ...
                    staticContainer.WebRequestsContainer.GetTextureArgsFactory,
                    notificationsBusController),
                new RewardPanelPlugin(container.MvcManager, assetsProvisioner, notificationsBusController, staticContainer.WebRequestsContainer.WebRequestController, staticContainer.WebRequestsContainer.GetTextureArgsFactory),
                new PassportPlugin(
                    assetsProvisioner,
                    container.MvcManager,
                    dclCursor,
