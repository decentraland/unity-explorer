...
namespace Global.Dynamic
{
    public class DynamicWorldContainer : IDCLPlugin<DynamicWorldSettings>
    {
            ...
            CancellationToken ct)
        {
            ...
            var nftInfoAPIService = new NftInfoAPIService(new OpenSeaAPIClient(staticContainer.WebRequestsContainer.WebRequestController));
            ...
            var globalPlugins = new List<IDCLGlobalPlugin>
            {
                ...
                new NftPromptPlugin(staticContainer.AssetsProvisioner, webBrowser, container.MvcManager, nftInfoAPIService, staticContainer.WebRequestsContainer.WebRequestController),
