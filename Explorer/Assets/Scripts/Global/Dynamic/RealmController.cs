...
namespace Global.Dynamic
{
    public class RealmController : IRealmController
    {
        ...
        /// </summary>
        public async UniTask SetRealmAsync(URLDomain realm, Vector2Int playerStartPosition,
            AsyncLoadProcessReport loadReport, CancellationToken ct)
        {
            ...
            try
            {
                await UniTask.WhenAll(
                    sceneLoadReport.PropagateAsync(loadReport, ct, loadReport.ProgressCounter.Value,
        ...
        public async UniTask SetRealmAsync(URLDomain realm, CancellationToken ct)
        {
            ...
            IRetrieveScene sceneProviderStrategy =
                realmData.ScenesAreFixed ? retrieveSceneFromFixedRealm : retrieveSceneFromVolatileWorld;
