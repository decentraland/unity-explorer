    ...
    public class StaticContainer : IDCLPlugin<StaticSettings>
    {
            ...
            CancellationToken ct)
        {
            ...
            container.ECSWorldPlugins = new IDCLWorldPlugin[]
            {
                ...
                new CameraTransformPlugin(exposedGlobalDataContainer.ExposedCameraData.CameraEntityProxy, container.GlobalWorldProxy, componentsContainer.ComponentPoolsRegistry),
