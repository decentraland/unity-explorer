...
namespace Global
{
    ...
    public class StaticContainer : IDCLPlugin<StaticSettings>
    {
            ...
            CancellationToken ct)
        {
            ...
            container.PortableExperiencesController = new ECSPortableExperiencesController(globalWorld, web3IdentityProvider, container.WebRequestsContainer.WebRequestController, container.ScenesCache, container.FeatureFlagsCache, localSceneDevelopment);
