...
namespace ECS.Unity.GLTFContainer.Systems
{
    ...
    public partial class CleanUpGltfContainerSystem : BaseUnityLoopSystem, IFinalizeWorldSystem
    {
        ...
        internal CleanUpGltfContainerSystem(World world, IDereferencableCache<GltfContainerAsset, string> cache,
        ...
        private readonly struct ReleaseOnEntityDestroy : IForEach<GltfContainerComponent>
        {
            ...
            public ReleaseOnEntityDestroy(IDereferencableCache<GltfContainerAsset, string> cache,
                IEntityCollidersSceneCache entityCollidersSceneCache, World world)
            {
                this.cache = cache;
                this.world = world;
