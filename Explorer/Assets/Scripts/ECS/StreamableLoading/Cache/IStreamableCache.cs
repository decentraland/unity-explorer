...
namespace ECS.StreamableLoading.Cache
{
    ...
    public interface IStreamableCache<TAsset, TLoadingIntention> : IEqualityComparer<TLoadingIntention>, IDisposable
    {
        ...
        class Fake : IStreamableCache<TAsset, TLoadingIntention>
        {
            ...
            public IDictionary<string, UniTaskCompletionSource<StreamableLoadingResult<TAsset>?>>
                OngoingRequests { get; } =
                new Dictionary<string, UniTaskCompletionSource<StreamableLoadingResult<TAsset>?>>();

            public IDictionary<string, StreamableLoadingResult<TAsset>> IrrecoverableFailures { get; } =
                new Dictionary<string, StreamableLoadingResult<TAsset>>();
