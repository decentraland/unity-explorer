...
namespace ECS.StreamableLoading.Textures
{
    ...
    {
        internal LoadTextureSystem(World world, IConcurrentBudgetProvider memoryBudgetProvider, IStreamableCache<Texture2D, GetTextureIntention> cache, MutexSync mutexSync)
