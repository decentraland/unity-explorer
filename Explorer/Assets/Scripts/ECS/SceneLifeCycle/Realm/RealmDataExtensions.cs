...
namespace ECS
{
    public static class RealmDataExtensions
    {
        ...
        public static bool IsGenesis(this IRealmData realmController) =>
            realmController.RealmType.Value is RealmKind.GenesisCity;

        public static bool IsLocalScene(this IRealmData realmController) =>
            realmController.RealmType.Value is RealmKind.LocalScene;
