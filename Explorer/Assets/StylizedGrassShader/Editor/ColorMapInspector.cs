...
namespace StylizedGrass
{
    ...
    public class ColorMapInspector : Editor
    {
        ...
        private SerializedProperty overrideTexture;
        private SerializedProperty texture;
        private SerializedProperty customTex;
        ...
        public override bool HasPreviewGUI() =>
            colorMap.texture && !overrideTexture.boolValue;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Set as active", GUILayout.MaxWidth(150f))) { colorMap.SetActive(); }
            ...
            if (overrideTexture.boolValue) { EditorGUILayout.PropertyField(customTex); }

            if (colorMap.texture == null) { EditorGUILayout.HelpBox("No texture has been saved to this asset. Use the ColorMapRenderer component to do this", MessageType.Error); }
