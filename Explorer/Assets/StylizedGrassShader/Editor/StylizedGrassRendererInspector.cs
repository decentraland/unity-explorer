...
namespace StylizedGrass
{
    ...
    {
        private StylizedGrassRenderer script;
        private SerializedProperty colorMap;
        private SerializedProperty listenToWindZone;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!renderFeaturePresent)
            {
                ...
                using (new EditorGUILayout.HorizontalScope())
                {
                    ...
                    if (GUILayout.Button("Add", GUILayout.Width(60))) { AddRenderFeature(); }
            ...
            if (colorMap.objectReferenceValue == null && GrassColorMapRenderer.Instance) { EditorGUILayout.HelpBox("A Colormap Renderer component is present, you don't have to assign a colormap in this case", MessageType.Info); }
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                if (listenToWindZone.boolValue)
                {
                    ...
                    if (!windZone.objectReferenceValue)
                    {
                        ...
                        {
                            var windZoneGameObject = new GameObject("Wind Zone", typeof(WindZone));
