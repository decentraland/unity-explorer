...
namespace StylizedGrass
{
    ...
    public class GrassColorMapRenderer : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("thirdPartyShader")]
        ...
        public bool useOriginalMaterials;
        [NonSerialized]
        ...
        public List<LayerScaleSettings> layerScaleSettings = new ();
        ...
        private void Reset()
        {
            ...
            if (gameObject.name == "GameObject") gameObject.name = "Grass Colormap Renderer";
        }
