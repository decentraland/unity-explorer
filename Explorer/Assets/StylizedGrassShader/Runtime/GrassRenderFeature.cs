...
{
    [MovedFrom(true, "StylizedGrass", "sc.stylizedgrass.runtime", "GrassBendingFeature")]
    public class GrassRenderFeature : ScriptableRendererFeature
    {
        public class RenderBendVectors : ScriptableRenderPass
        {
            ...
            private static readonly ProfilingSampler profilerSamplerRendering = new (profilerTagPass);
            ...
            private static readonly Color neutralVector = new (0.5f, 0f, 0.5f, 0f);
...
#pragma warning disable CS0618
            ...
            public static void DrawOrthographicViewGizmo()
            {
                ...
                var position = new Vector3(view.inverse.m03, view.inverse.m13 + (height * 0.5f), view.inverse.m23);
                var scale = new Vector3(frustrumPlanes[0].distance + frustrumPlanes[1].distance, height, frustrumPlanes[2].distance + frustrumPlanes[3].distance);
...
#pragma warning disable CS0618
        ...
        public class Settings
        {
            ...
            [FormerlySerializedAs("renderRange")]
            [Min(10f)]
...
#if UNITY_EDITOR
            settings.ditheringNoise = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetDatabase.GUIDToAssetPath("81200413a40918d4d8702e94db29911c"));
#endif
        }
        ...
        private void OnEnable()
        {
            ...
            if (PipelineUtilities.RenderGraphEnabled()) { Debug.LogError($"[{name}] Render Graph is enabled but is not supported. Enable \"Compatibility Mode\" in your project's Graphics Settings as a workaround."); }
#endif
        }
