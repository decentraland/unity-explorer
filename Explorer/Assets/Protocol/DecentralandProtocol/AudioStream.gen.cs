...
namespace DCL.ECSComponents {
  ...
  #endif
  {
    ...
    private readonly static bool SpatialDefaultValue = false;
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool Spatial {
      get { if ((_hasBits0 & 4) != 0) { return spatial_; } else { return SpatialDefaultValue; } }
      set {
        _hasBits0 |= 4;
        spatial_ = value;
      }
    ...
    private readonly static float SpatialMinDistanceDefaultValue = 0F;
    ...
    public float SpatialMinDistance {
      get { if ((_hasBits0 & 8) != 0) { return spatialMinDistance_; } else { return SpatialMinDistanceDefaultValue; } }
      set {
        _hasBits0 |= 8;
    ...
    private readonly static float SpatialMaxDistanceDefaultValue = 0F;
    ...
    public float SpatialMaxDistance {
      get { if ((_hasBits0 & 16) != 0) { return spatialMaxDistance_; } else { return SpatialMaxDistanceDefaultValue; } }
      set {
        _hasBits0 |= 16;
