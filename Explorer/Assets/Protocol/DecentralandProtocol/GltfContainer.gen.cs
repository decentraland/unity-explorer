...
namespace DCL.ECSComponents {
  ...
  #endif
  {
    ...
    private readonly static uint VisibleMeshesCollisionMaskDefaultValue = 0;
    ...
    public uint VisibleMeshesCollisionMask {
      get { if ((_hasBits0 & 1) != 0) { return visibleMeshesCollisionMask_; } else { return VisibleMeshesCollisionMaskDefaultValue; } }
      set {
        _hasBits0 |= 1;
    ...
    private readonly static uint InvisibleMeshesCollisionMaskDefaultValue = 0;
    ...
    public uint InvisibleMeshesCollisionMask {
      get { if ((_hasBits0 & 2) != 0) { return invisibleMeshesCollisionMask_; } else { return InvisibleMeshesCollisionMaskDefaultValue; } }
      set {
        _hasBits0 |= 2;
