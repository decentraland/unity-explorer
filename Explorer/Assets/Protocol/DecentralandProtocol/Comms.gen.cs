...
namespace Decentraland.Kernel.Comms.Rfc4 {
  ...
  #endif
  {
    ...
    private readonly static bool IsStoppingDefaultValue = false;
    ...
    public bool IsStopping {
      get { if ((_hasBits0 & 1) != 0) { return isStopping_; } else { return IsStoppingDefaultValue; } }
      set {
        _hasBits0 |= 1;
        isStopping_ = value;
      }
  ...
  #endif
  {
    ...
    private readonly static string ForwardedFromDefaultValue = "";
    ...
    public string ForwardedFrom {
      get { return forwardedFrom_ ?? ForwardedFromDefaultValue; }
      set {
