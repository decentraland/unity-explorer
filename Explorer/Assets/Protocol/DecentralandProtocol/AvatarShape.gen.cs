...
namespace DCL.ECSComponents {
  ...
  #endif
  {
    ...
    private readonly static string BodyShapeDefaultValue = "";
    ...
    public string BodyShape {
      get { return bodyShape_ ?? BodyShapeDefaultValue; }
      set {
    ...
    private readonly static string ExpressionTriggerIdDefaultValue = "";
    ...
    public string ExpressionTriggerId {
      get { return expressionTriggerId_ ?? ExpressionTriggerIdDefaultValue; }
      set {
    ...
    private readonly static long ExpressionTriggerTimestampDefaultValue = 0L;
    ...
    public long ExpressionTriggerTimestamp {
      get { if ((_hasBits0 & 1) != 0) { return expressionTriggerTimestamp_; } else { return ExpressionTriggerTimestampDefaultValue; } }
      set {
        _hasBits0 |= 1;
    ...
    private readonly static bool TalkingDefaultValue = false;
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool Talking {
      get { if ((_hasBits0 & 2) != 0) { return talking_; } else { return TalkingDefaultValue; } }
      set {
        _hasBits0 |= 2;
        talking_ = value;
      }
    ...
    private readonly static bool ShowOnlyWearablesDefaultValue = false;
    ...
    public bool ShowOnlyWearables {
      get { if ((_hasBits0 & 4) != 0) { return showOnlyWearables_; } else { return ShowOnlyWearablesDefaultValue; } }
      set {
        _hasBits0 |= 4;
