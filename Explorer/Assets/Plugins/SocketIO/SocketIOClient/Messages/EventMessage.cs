    ...
    public class EventMessage : IJsonMessage
    {
        ...
        public void Read(string msg)
        {
            ...
            if (lastIndex > -1)
            {
                ...
                if (index - lastIndex > 1) { Id = int.Parse(text.Substring(lastIndex + 1)); }
            }
            else
            {
                if (index > 0) { Id = int.Parse(msg.Substring(0, index)); }
            }
            ...
            //    msg = msg.Substring(index);
            //}
            JsonElement.ArrayEnumerator array = JsonDocument.Parse(msg).RootElement.EnumerateArray();
            int i = -1;
