...
namespace SocketIOClient.Messages
{
    public class OpenedMessage : IMessage
    {
        ...
        {
            JsonElement p = element.GetProperty(name);
            int val;
        ...
        public void Read(string msg)
        {
            ...
            JsonElement.ArrayEnumerator upgrades = root.GetProperty("upgrades").EnumerateArray();

            foreach (JsonElement item in upgrades) { Upgrades.Add(item.GetString()); }
        }
