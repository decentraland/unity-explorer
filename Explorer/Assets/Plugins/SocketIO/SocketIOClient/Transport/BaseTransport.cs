...
namespace SocketIOClient.Transport
{
    public abstract class BaseTransport : ITransport
    {
        ...
        protected virtual async Task OpenAsync(OpenedMessage msg)
        {
            ...
            if (Options.EIO == EngineIO.V3 && string.IsNullOrEmpty(Namespace)) { return; }
            ...
            if (Options.EIO == EngineIO.V4) { connectMsg.AuthJsonStr = Options.Auth; }
        ...
        protected async Task OnTextReceived(string text)
        {
            ...
            if (msg.Type == MessageType.Ping)
            {
                ...
                catch (Exception e) { OnError.TryInvoke(e); }
            }
        }
