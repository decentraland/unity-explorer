...
namespace DCL.ApplicationGuards
{
    public class SystemSpecUtilsShould
    {
        ...
        [TestCase("Intel Core 7 150U", true, TestName = "Intel Core 7 (non-Ultra) is accepted")]
        [TestCase("Intel(R) Core(TM) 7 Processor 150U", true, TestName = "Intel Core 7 with trademark symbols is accepted")]
        [TestCase("Intel Core 5 120U", true, TestName = "Intel Core 5 (non-Ultra) is accepted")]
        [TestCase("Intel Core 9 185H", true, TestName = "Intel Core 9 (non-Ultra) is accepted")]
        [TestCase("Intel Core 3 100U", false, TestName = "Intel Core 3 (non-Ultra) is rejected")]
