...
namespace DCL.CommunicationData.Tests
{
    public class URNShould
    {
        ...
        [TestCase("urn:decentraland:amoy:collections-thirdparty:back-to-the-future:amoy-eb54:earrings-9d5c:amoy:0x1d9fb685c257e74f869ba302e260c0b68f5ebb37:5")]
        [TestCase("urn:decentraland:amoy:collections-thirdparty:back-to-the-future:amoy-eb54:earrings-9d5c")]
        public void DoNotShortenThirdPartyUrns(string urnStr)
        {
            URN urn = urnStr;
        ...
        [TestCase("urn:decentraland:matic:collections-v2:0x49ae7292b773e3906070c102229a80056cd520f2:0:39")]
        [TestCase("urn:decentraland:matic:collections-v2:0x4c3dbbb91776895e9253b5932d52161a8cfd69d5:0:106")]
        [TestCase("urn:decentraland:amoy:collections-v2:0x37ea2017c7793adbb996f1758bcb32a7fc7ef4e7:2:21062458333711437339583605536734086463779019080109822250862195508")]
        [TestCase("urn:decentraland:matic:collections-v2:0x404167842ac7b205dd8417705b813f34198b11df:0:196")]
        public void IsExtended(string urnStr)
        {
            URN urn = urnStr;
            Assert.IsTrue(urn.IsExtended());
        }

        [TestCase("urn:decentraland:matic:collections-v2:0x49ae7292b773e3906070c102229a80056cd520f2:0")]
        [TestCase("urn:decentraland:matic:collections-v2:0x269605b96948fa09732d78ab4c81e6cc48bc4110:0")]
        [TestCase("urn:decentraland:amoy:collections-thirdparty:back-to-the-future:amoy-eb54:earrings-9d5c:amoy:0x1d9fb685c257e74f869ba302e260c0b68f5ebb37:5")]
        [TestCase("urn:decentraland:matic:collections-v2:0x074d021b43211cd660b7ace567315bcd6dd3e486:0")]
        public void IsNotExtended(string urnStr)
        {
            URN urn = urnStr;
            Assert.IsFalse(urn.IsExtended());
        }
    }
}
