...
inline void InitializeBRDFData(inout SurfaceData_Scene surfaceData, out BRDFData brdfData)
{
...
BRDFData CreateClearCoatBRDFData(SurfaceData_Scene surfaceData, inout BRDFData brdfData)
{
