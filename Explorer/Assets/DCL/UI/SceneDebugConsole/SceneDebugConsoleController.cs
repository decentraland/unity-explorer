...
namespace DCL.UI.SceneDebugConsole
{
    public class SceneDebugConsoleController : ControllerBase<SceneDebugConsoleView>
    {
        ...
        protected override void OnViewInstantiated()
        {
            ...
            // logMessagesBus.Send("4. TEST LOG!!!", LogType.Log);
