...
namespace DCL.UI
{
    public class ChatOptionsContextMenuController
    {
        ...
        public ChatOptionsContextMenuController(IMVCManager mvcManager, Sprite deleteChatHistoryIcon, string deleteChatHistoryText, Action onDeleteChatHistoryClicked)
        {
            ...
            contextMenu = new GenericContextMenu(CONTEXT_MENU_WIDTH, CONTEXT_MENU_OFFSET, CONTEXT_MENU_VERTICAL_LAYOUT_PADDING, CONTEXT_MENU_ELEMENTS_SPACING, anchorPoint: ContextMenuOpenDirection.TopLeft)
