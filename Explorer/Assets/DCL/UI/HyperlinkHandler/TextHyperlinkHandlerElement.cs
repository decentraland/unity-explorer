...
namespace DCL.UI.HyperlinkHandler
{
    ...
    public class TextHyperlinkHandlerElement : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler, IViewWithGlobalDependencies
    {
        ...
        private async UniTaskVoid OpenUserProfileContextMenuAsync(string userName)
        {
            ...
            await viewDependencies.GlobalUIViews.ShowUserProfileContextMenuAsync(profile.ValidatedName, GetLastCharacterPosition(lastLink), cancellationTokenSource.Token);
        }
