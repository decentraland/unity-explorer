...
namespace DCL.FeatureFlags
{
    ...
    public partial class FeaturesRegistry
    {
            ...
            bool localSceneDevelopment)
        {
            ...
            SetFeatureState(FeatureId.VOICE_CHAT, true);//IsEnabled(FeatureId.FRIENDS) && IsEnabled(FeatureId.FRIENDS_USER_BLOCKING) && (Application.isEditor || featureFlags.IsEnabled(FeatureFlagsStrings.VOICE_CHAT) || (appArgs.HasDebugFlag() && appArgs.HasFlag(AppArgsFlags.VOICE_CHAT))));
