    ...
    public partial class FeaturesRegistry
    {
            ...
            bool localSceneDevelopment)
        {
            ...
            SetFeatureStates(new Dictionary<FeatureId, bool>
            {
                ...
                [FeatureId.PrimitiveInstancing] = appArgs.ResolveFeatureFlagArg(AppArgsFlags.PRIMITIVE_INSTANCING, featureFlags.IsEnabled(FeatureFlagsStrings.PRIMITIVE_INSTANCING) || isEditor, requireDebug: false),
