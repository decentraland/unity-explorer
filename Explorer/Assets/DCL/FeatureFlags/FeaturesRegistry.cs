    ...
    public partial class FeaturesRegistry
    {
            ...
            bool localSceneDevelopment)
        {
            ...
            SetFeatureStates(new Dictionary<FeatureId, bool>
            {
                ...
                [FeatureId.EventFeaturedItems] = appArgs.ResolveFeatureFlagArg(AppArgsFlags.EVENT_FEATURED_ITEMS, featureFlags.IsEnabled(FeatureFlagsStrings.EVENT_FEATURED_ITEMS) || isEditor),
