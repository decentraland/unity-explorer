...
namespace DCL.Multiplayer.Movement
{
    ...
    public static class InterpolationSpline
    {
        ...
        {
            (start.velocity.y, end.velocity.y) = Monotonize(start.position.y, end.position.y, start.velocity.y, end.velocity.y, (float)(end.timestamp - start.timestamp));
        ...
        {
            var timeDiff = (float)(end.timestamp - start.timestamp);
