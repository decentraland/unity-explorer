...
namespace DCL.Multiplayer.Connections.Rooms
{
    ...
    {
        public static string ReadableString(this LKParticipant participant) =>
#if !UNITY_WEBGL
...
#if !UNITY_WEBGL
        public static string ToLivekitAddress(this LKParticipant participant, TrackPublication trackPublication) =>
