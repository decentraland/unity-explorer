...
namespace DCL.Multiplayer.Connections.Demo
{
    public class LocalSceneDevelopmentPlayground : MonoBehaviour
    {
        ...
        private async UniTaskVoid LaunchAsync()
        {
            ...
            var webRequests = new LogWebRequestController(new DefaultWebRequestController(new WebRequestsAnalyticsContainer(), identityCache, new RequestHub(urlsSource, HTTPManager.LocalCache, false, 0L, 1, false, WebRequestsMode.UNITY)));
