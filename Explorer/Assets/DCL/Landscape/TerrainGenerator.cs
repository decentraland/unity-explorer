...
namespace DCL.Landscape
{
    public class TerrainGenerator : IDisposable, ITerrain
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            NativeHashSet<int2> occupiedParcels = worldManifest.GetOccupiedParcels(); // Do NOT dispose — owned by WorldManifest
            var worldModel = new WorldModel(occupiedParcels.AsReadOnly());
