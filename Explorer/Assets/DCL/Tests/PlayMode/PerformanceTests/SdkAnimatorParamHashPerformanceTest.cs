...
namespace DCL.Tests.PlayMode.PerformanceTests
{
    ...
    public class SdkAnimatorParamHashPerformanceTest
    {
        ...
        public void SetUp()
        {
            ...
            // Layer 0 is Unity's base layer, whose weight is permanently pinned to 1.0 (SetLayerWeight(0, x) is a no-op).
            // Add a throwaway base layer first so clipA / walk-cycle map to non-base indices and the not-playing
            // zero-weight assertion below stays meaningful.
            controller.AddLayer("__base");
