...
{
    internal class SearchResultMarker : ISearchResultMarker
    {
        internal const int MAX_TITLE_LENGTH = 29;

        private readonly IMapCullingController cullingController;

        private MapMarkerPoolableBehavior<SearchResultMarkerObject> poolableBehavior;
        ...
        {
            poolableBehavior = new MapMarkerPoolableBehavior<SearchResultMarkerObject>(objectsPool);
        ...
        public void OnBecameVisible()
        {
            ...
            // time instead of four (matches PinMarker.OnBecameVisible).
            SearchResultMarkerObject obj = poolableBehavior.OnBecameVisible();
