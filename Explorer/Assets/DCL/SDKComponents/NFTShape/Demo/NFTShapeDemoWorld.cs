    ...
    public class NFTShapeDemoWorld : IDemoWorld
    {
            ...
            IReadOnlyList<(PBNftShape textShape, PBVisibilityComponent visibility, PBBillboard billboard)> list)
        {
            ...
            origin = new DemoWorld(
                ...
                w => new LoadCycleNftShapeSystem(w, new BasedURNSource(new DecentralandUrlsSource(DecentralandEnvironment.Org, ILaunchMode.PLAY)), VideoTextureFactory.CreateVideoTexturesPool()),
