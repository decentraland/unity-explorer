...
using UnityEngine;
using Utility;
using Promise = ECS.StreamableLoading.Common.AssetPromise<UnityEngine.AudioClip,
        ECS.StreamableLoading.AudioClips.GetAudioClipIntention>;
...
namespace DCL.SDKComponents.AudioSources
{
    ...
    public partial class UpdateAudioSourceSystem : BaseUnityLoopSystem
    {
        ...
        internal UpdateAudioSourceSystem(World world, ISceneData sceneData, ISceneStateProvider sceneStateProvider,
            IDereferencableCache<AudioClip, GetAudioClipIntention> cache, IComponentPoolsRegistry poolsRegistry,
        ...
        private void CreateAudioSource(ref PBAudioSource sdkAudioSource, ref AudioSourceComponent audioSourceComponent, ref TransformComponent entityTransform)
        {
            ...
            audioSourceComponent.AudioSource.FromPBAudioSourceWithClip(audioSourceComponent.PBAudioSource,
                clip: promiseResult.Asset);

            // Reset isDirty as we just applied the PBAudioSource to the AudioSource
            sdkAudioSource.IsDirty = false;

            var transform = audioSourceComponent.AudioSource.transform;
        ...
        private void UpdateAudioSource(ref PBAudioSource sdkComponent, ref AudioSourceComponent component,
        ...
        private void HandleSDKChanges(PBAudioSource sdkComponent, ref AudioSourceComponent component,
            PartitionComponent partitionComponent)
        {
            ...
            if (component.AudioClipUrl != sdkComponent.AudioClipUrl)
            {
                ...
                if (AudioUtils.TryCreateAudioClipPromise(world, sceneData, sdkComponent.AudioClipUrl,
                        partitionComponent, out Promise? clipPromise))
