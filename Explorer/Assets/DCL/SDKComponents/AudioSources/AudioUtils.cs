...
namespace DCL.SDKComponents.AudioSources
{
    ...
    {
        public static void CleanUp(this AudioSourceComponent component, World world, IStreamableCache<AudioClip, GetAudioClipIntention> cache, IComponentPool componentPool)
        {
