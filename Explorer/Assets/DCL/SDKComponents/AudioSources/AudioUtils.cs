...
namespace DCL.SDKComponents.AudioSources
{
    public static class AudioUtils
    {
        public static void CleanUp(this ref AudioSourceComponent component, World world,
            IDereferencableCache<AudioClip, GetAudioClipIntention> cache, IComponentPool componentPool)
        {
        ...
        public static bool TryCreateAudioClipPromise(World world, ISceneData sceneData, string pbAudioClipUrl,
            PartitionComponent partitionComponent, out Promise? assetPromise)
        {
