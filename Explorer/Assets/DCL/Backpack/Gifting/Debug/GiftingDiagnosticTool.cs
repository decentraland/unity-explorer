...
namespace DCL.Backpack.Gifting.Debug
{
    public class GiftingDiagnosticTool : MonoBehaviour
    {
        ...
        [ContextMenu("6. Prune Wearables")]
        public void PruneWearables()
        {
            ReportHub.Log(ReportCategory.GIFTING, "=== Pruning Wearables ===");
            pendingTransferService.PruneWearables(wearableStorage.AllOwnedNftRegistry);
            pendingTransferService.LogPendingTransfers();
        }
        
        [ContextMenu("7. Prune Emotes")]
        public void PruneEmotes()
        {
            ReportHub.Log(ReportCategory.GIFTING, "=== Pruning Emotes ===");
            pendingTransferService.PruneEmotes(emoteStorage.AllOwnedNftRegistry);
            pendingTransferService.LogPendingTransfers();
        }
        
        [ContextMenu("8. Prune All")]
        public void PruneAll()
        {
            ReportHub.Log(ReportCategory.GIFTING, "=== Pruning All ===");
            pendingTransferService.PruneWearables(wearableStorage.AllOwnedNftRegistry);
            pendingTransferService.PruneEmotes(emoteStorage.AllOwnedNftRegistry);
            pendingTransferService.LogPendingTransfers();
        }
