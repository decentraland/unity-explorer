...
public class UpdateVisualSceneStateSystemShould : UnitySystemTestBase<UpdateVisualSceneStateSystem>
{
    ...
    public void Setup()
    {
        ...
        system = new UpdateVisualSceneStateSystem(world, realmData, scenesCahce, lodAssetsPool, lodSettings, new VisualSceneStateResolver(new HashSet<Vector2Int>()), null);
    }
