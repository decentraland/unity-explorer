...
LightingData CreateLightingData(InputData_Scene inputData, SurfaceData_Scene surfaceData)
{
...
half3 CalculateBlinnPhong(Light light, InputData_Scene inputData, SurfaceData_Scene surfaceData)
{
...
/// PBR lighting...
////////////////////////////////////////////////////////////////////////////////
half4 UniversalFragmentPBR(InputData_Scene inputData, SurfaceData_Scene surfaceData)
{
...
half4 UniversalFragmentPBR(InputData_Scene inputData, half3 albedo, half metallic, half3 specular,
...
/// Phong lighting...
////////////////////////////////////////////////////////////////////////////////
half4 UniversalFragmentBlinnPhong(InputData_Scene inputData, SurfaceData_Scene surfaceData)
{
    #if defined(DEBUG_DISPLAY)
    half4 debugColor;
...
// Deprecated: Use the version which takes "SurfaceData" instead of passing all of these arguments...
half4 UniversalFragmentBlinnPhong(InputData_Scene inputData, half3 diffuse, half4 specularGloss, half smoothness, half3 emission, half alpha, half3 normalTS)
{
    SurfaceData_Scene surfaceData;
...
/// Unlit
////////////////////////////////////////////////////////////////////////////////
half4 UniversalFragmentBakedLit(InputData_Scene inputData, SurfaceData_Scene surfaceData)
{
    #if defined(DEBUG_DISPLAY)
    half4 debugColor;
...
// Deprecated: Use the version which takes "SurfaceData" instead of passing all of these arguments...
half4 UniversalFragmentBakedLit(InputData_Scene inputData, half3 color, half alpha, half3 normalTS)
{
    SurfaceData_Scene surfaceData;
