...
#include "LightCookie/Scene_LightCookie.hlsl"
#include "Scene_Clustering.hlsl"
...
Light GetMainLight(InputData_Scene inputData, half4 shadowMask, AmbientOcclusionFactor aoFactor)
{
...
Light GetAdditionalLight(uint i, InputData_Scene inputData, half4 shadowMask, AmbientOcclusionFactor aoFactor)
{
...
half4 CalculateShadowMask(InputData_Scene inputData)
{
