...
namespace DCL.LOD.Systems
{
    ...
    public partial class UpdateSceneLODInfoSystem : BaseUnityLoopSystem
    {
        ...
        private void UpdateLODLevel(ref SceneLODInfo sceneLODInfo, ref PartitionComponent partitionComponent, SceneDefinitionComponent sceneDefinitionComponent, ref SceneLoadingState sceneState, ref StaticSceneAssetBundle staticSceneAssetBundle)
        {
        ...
        {
            if (level == 0 && sceneDefinitionComponent.Definition.SupportsStaticScene())
            {
            ...
            var assetBundleIntention = GetAssetBundleIntention.FromHash(typeof(GameObject),
                ...
                assetBundleManifestVersion: new AssetBundleManifestVersion($"LOD/{level.ToString()}", "dummyDate")
                );
