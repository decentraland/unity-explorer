...
namespace DCL.Ipfs
{
    ...
    public class ServerAbout
    {
        ...
        {
            this.configurations = configurations ?? new ServerConfiguration { networkId = 0, realmName = string.Empty, scenesUrn = new List<string>(), occupiedParcels = new List<string>() };
