...
namespace DCL.PluginSystem.Global
{
    public class DefaultTexturesContainer : DCLWorldContainer<DefaultTexturesContainer.Settings>
    {
        ...
        public class Settings : IDCLPluginSettings
        {
            ...
            [field: SerializeField]
            public AssetReferenceTexture DefaultMetallicGloss256 { get; private set; }

            [field: SerializeField]
            public AssetReferenceTexture DefaultMetallicGloss512 { get; private set; }
            ...
            CancellationToken ct)
        {
            ...
            return await container.InitializeContainerAsync<DefaultTexturesContainer, Settings>(settingsContainer, ct, async texturesContainer =>
            {
                ...
                defaultTextures.Add(new TextureArrayKey(TextureArrayConstants.MAINTEX_TEX_ARR, 256), mainTex256);
                defaultTextures.Add(new TextureArrayKey(TextureArrayConstants.MAINTEX_TEX_ARR, 512) , mainTex512);
                ...
                defaultTextures.Add(new TextureArrayKey(TextureArrayConstants.METALLIC_GLOSS_MAP_TEX_ARR, 256), (await assetsProvisioner.ProvideMainAssetAsync(settings.DefaultMetallicGloss256, ct: ct)).Value);
                defaultTextures.Add(new TextureArrayKey(TextureArrayConstants.METALLIC_GLOSS_MAP_TEX_ARR, 512), (await assetsProvisioner.ProvideMainAssetAsync(settings.DefaultMetallicGloss512, ct: ct)).Value);
                defaultTextures.Add(new TextureArrayKey(TextureArrayConstants.MASK_TEX_ARR, 256, 0), (await assetsProvisioner.ProvideMainAssetAsync(settings.DefaultMouthBrowMask256, ct: ct)).Value);
                defaultTextures.Add(new TextureArrayKey(TextureArrayConstants.MASK_TEX_ARR, 512, 0), (await assetsProvisioner.ProvideMainAssetAsync(settings.DefaultMouthBrowMask512, ct: ct)).Value);
                defaultTextures.Add(new TextureArrayKey(TextureArrayConstants.MASK_TEX_ARR, 256, 1), (await assetsProvisioner.ProvideMainAssetAsync(settings.DefaultEyesMask256, ct: ct)).Value);
                defaultTextures.Add(new TextureArrayKey(TextureArrayConstants.MASK_TEX_ARR, 512, 1), (await assetsProvisioner.ProvideMainAssetAsync(settings.DefaultEyesMask512, ct: ct)).Value);
