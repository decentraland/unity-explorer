    ...
    public class SidebarPlugin : IDCLGlobalPlugin<SidebarPlugin.SidebarSettings>
    {
        ...
        public async UniTask InitializeAsync(SidebarSettings settings, CancellationToken ct)
        {
            ...
            mvcManager.RegisterController(new SidebarController(() =>
                ...
                new ProfileMenuController(() => mainUIView.SidebarView.ProfileMenuView, web3IdentityCache, profileRepository, webRequestController, world, playerEntity, webBrowser, web3Authenticator, userInAppInitializationFlow, profileCache, mvcManager, sharedSpaceManager),
                new SkyboxMenuController(() => mainUIView.SidebarView.SkyboxMenuView, settings.SkyboxSettingsAsset, sharedSpaceManager),
