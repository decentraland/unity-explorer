...
namespace DCL.PluginSystem.Global
{
    public class AvatarPlugin : IDCLGlobalPlugin<AvatarPlugin.AvatarShapeSettings>
    {
        ...
        private UIDocument nametagsDocument;
        private NametagStressTest debugStressTest;
        ...
        public async UniTask InitializeAsync(AvatarShapeSettings settings, CancellationToken ct)
        {
            ...
            nametagElementPool = new ObjectPool<NametagElement>(() => new NametagElement(),
                ne => nametagsDocument.rootVisualElement.Add(ne),
                ne => ne.RemoveFromHierarchy()
            );
            ...
            nametagsDocument = (await assetsProvisioner.ProvideInstanceAsync(settings.NametagsUIDocument, ct: ct)).Value;
            ...
            debugContainerBuilder.TryAddWidget("Nametags")
                                ?.AddToggleField("ShowNametags", _ => nametagsData.showNameTags = !nametagsData.showNameTags, nametagsData.showNameTags)
                                 .AddSingleButton("Init Stress Test", () => debugStressTest = debugStressTest == null ? nametagsDocument.gameObject.AddComponent<NametagStressTest>() : debugStressTest)
                                 .AddSingleButton("Spawn Stress Elements", () => debugStressTest.SpawnNametags())
                                 .AddSingleButton("Clear Stress Elements", () => debugStressTest.ClearNametags())
                                 .AddSingleButton("Say Hi Stress", () => debugStressTest.SayHi())
                                 .AddSingleButton("Toggle Stress Movement", () => debugStressTest.ToggleMovement());
        }
        ...
        public void InjectToWorld(ref ArchSystemsWorldBuilder<Arch.Core.World> builder, in GlobalPluginArguments arguments)
        {
            ...
            NametagPlacementSystem.InjectToWorld(ref builder, nametagElementPool, nametagsData, nametagsDocument.rootVisualElement);
            NameTagCleanUpSystem.InjectToWorld(ref builder, nametagsData, nametagElementPool);
        ...
        public class AvatarShapeSettings : IDCLPluginSettings
        {
            ...
            [field: SerializeField]
            public UIDocumentRef NametagsUIDocument { get; set; }
