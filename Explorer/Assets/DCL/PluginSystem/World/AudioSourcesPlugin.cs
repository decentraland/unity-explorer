...
namespace DCL.PluginSystem.World
{
    public class AudioSourcesPlugin: IDCLWorldPlugin<AudioSourcesPlugin.AudioSourcesPluginSettings>
    {
        ...
        public void InjectToWorld(ref ArchSystemsWorldBuilder<Arch.Core.World> builder, in ECSWorldInstanceSharedDependencies sharedDependencies, in PersistentEntities persistentEntities, List<IFinalizeWorldSystem> finalizeWorldSystems, List<ISceneIsCurrentListener> sceneIsCurrentListeners)
        {
            ...
            sceneIsCurrentListeners.Add(UpdateAudioSourceSystem.InjectToWorld(ref builder, sharedDependencies.SceneData, componentPoolsRegistry, frameTimeBudgetProvider, memoryBudgetProvider, audioMixer, sharedDependencies.SceneStateProvider));
