...
namespace DCL.SceneRunner.Scene
{
    ...
    public interface IISSDescriptor
    {
        ...
        /// <summary>
        ///     Whether the given AB request hash (already platform-suffixed) refers to an asset served by
        ///     the shared ISS bundle. Only meaningful in <see cref="State.Bundle"/>.
        /// </summary>
        bool IsBundleAsset(string platformSuffixedHash);
