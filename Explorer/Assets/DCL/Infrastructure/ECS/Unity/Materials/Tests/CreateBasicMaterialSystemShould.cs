...
namespace ECS.Unity.Materials.Tests
{
    public class CreateBasicMaterialSystemShould : UnitySystemTestBase<CreateBasicMaterialSystem>
    {
        ...
        public void SetUp()
        {
            basicMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/DCL/Infrastructure/ECS/Unity/Materials/MaterialReference/BasicShapeMaterial.mat");
        ...
        public void NotConstructMaterialIfTexturesLoadingNotFinished()
        {
            ...
            component.AlbedoTexPromise = AssetPromise<TextureData, GetTextureIntention>.Create(world, new GetTextureIntention(), PartitionComponent.TOP_PRIORITY);
