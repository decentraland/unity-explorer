...
namespace ECS.StreamableLoading.AssetBundles
{
    ...
    {
        internal LoadGlobalAssetBundleSystem(World world, IStreamableCache<AssetBundleData, GetAssetBundleIntention> cache, IWebRequestController webRequestController, AssetBundleLoadingMutex loadingMutex, ArrayPool<byte> buffersPool, IDiskCache<PartialLoadingState> partialsDiskCache, bool byteWeightedProgress) : base(world, cache, webRequestController, buffersPool, loadingMutex, partialsDiskCache, byteWeightedProgress, sceneContent: null, buildLocalAssetBundles: false) { }
    }
}
