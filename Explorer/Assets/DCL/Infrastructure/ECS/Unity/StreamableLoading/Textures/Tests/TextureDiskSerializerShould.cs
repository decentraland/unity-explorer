...
namespace ECS.StreamableLoading.Textures.Tests
{
    ...
    public class TextureDiskSerializerShould
    {
        ...
        // Regression guard: exactly the SERIALIZED mip 1 survives a round trip — the native mip-pyramid
        // regeneration pass (parameterless Apply(), updateMipmaps:true) must NOT run on a cache hit.
        [Test]
