...
namespace ECS.StreamableLoading.Textures.Tests
{
    ...
    public class TextureDataShould
    {
        ...
        // Red on revert: restoring the ReportHub.Log($"...{Asset.Texture?.name}") line dispatches through the
        // installed report handler on EVERY call, which the mocked scope records.
        [Test]
