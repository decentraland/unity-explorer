    ...
    public partial class LoadGltfContainerSystem : BaseUnityLoopSystem
    {
        ...
        private async UniTask LoadBigAssetBundle()
        {
            UnityWebRequest unityWebRequest =
                UnityWebRequestAssetBundle.GetAssetBundle("file:///Users/juanmolteni/Decentraland/unity-explorer/Explorer/Assets/genesisplaza_lz4");
            ...
            foreach (GameObject loaddedAsset in loaddedAssets)
            {
                loadedObjects.Add(loaddedAsset.name, loaddedAsset);

                //GameObject.Instantiate(loaddedAsset);
            }
