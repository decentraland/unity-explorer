...
namespace ECS.Unity.GLTFContainer.Tests
{
    public class LoadGltfContainerSystemShould : UnitySystemTestBase<LoadGltfContainerSystem>
    {
        ...
        public void SetUp()
        {
            ...
            system = new LoadGltfContainerSystem(world, eventBuffer = new EntityEventBuffer<GltfContainerComponent>(1), sceneData, Substitute.For<IEntityCollidersSceneCache>(), sceneStateProvider);
        ...
        public async Task ReconfigureInvisibleColliders(bool from, bool to)
        {
            ...
            ConfigureGltfContainerColliders.SetupColliders(ref component, result.Asset, isSceneCurrent: true);
