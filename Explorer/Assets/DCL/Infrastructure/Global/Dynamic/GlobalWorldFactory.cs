...
namespace Global.Dynamic
{
    public class GlobalWorldFactory
    {
        ...
        public GlobalWorld Create(ISceneFactory sceneFactory, Entity playerEntity)
        {
            ...
            LoadSceneDefinitionListSystem.InjectToWorld(ref builder, webRequestController, NoCache<SceneDefinitions, GetSceneDefinitionList>.INSTANCE, assetBundlesURL);
            LoadSceneDefinitionSystem.InjectToWorld(ref builder, webRequestController, NoCache<SceneEntityDefinition, GetSceneDefinition>.INSTANCE, assetBundlesURL);
            ...
            var finalizeWorldSystems = new IFinalizeWorldSystem[]
            {
                ...
                UnloadSceneLODSystem.InjectToWorld(ref builder, scenesCache, lodCache, staticContainer.GltfContainerAssetsCache),
