    ...
    public class DynamicWorldContainer : DCLWorldContainer<DynamicWorldSettings>
    {
            ...
            CancellationToken ct)
        {
            ...
            var globalPlugins = new List<IDCLGlobalPlugin>
            {
                ...
                new SkyboxPlugin(assetsProvisioner, dynamicSettings.DirectionalLight, staticContainer.ScenesCache, staticContainer.SceneRestrictionBusController, staticContainer.RealmData, appArgs.HasFlagWithValueFalse(AppArgsFlags.LANDSCAPE_TERRAIN_ENABLED)),
