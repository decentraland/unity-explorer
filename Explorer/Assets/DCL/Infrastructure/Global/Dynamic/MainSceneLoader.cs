...
namespace Global.Dynamic
{
    public class MainSceneLoader : MonoBehaviour, ICoroutineRunner
    {
        ...
        private async UniTask InitializeFlowAsync(CancellationToken ct)
        {
            ...
            WebRequestsContainer webRequestsContainer = await WebRequestsContainer.CreateAsync(globalPluginSettingsContainer, identityCache, texturesFuse, debugContainerBuilder, compressionEnabled, ct);
