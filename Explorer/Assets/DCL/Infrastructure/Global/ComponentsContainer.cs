    ...
    public struct ComponentsContainer
    {
        ...
        public static ComponentsContainer Create()
        {
            ...
            sdkComponentsRegistry
               ...
               .Add(SDKComponentBuilder<PBPhysicsTotalImpulse>.Create(ComponentID.PHYSICS_TOTAL_IMPULSE).AsProtobufComponent())
               .Add(SDKComponentBuilder<PBPhysicsTotalForce>.Create(ComponentID.PHYSICS_TOTAL_FORCE).AsProtobufComponent());
