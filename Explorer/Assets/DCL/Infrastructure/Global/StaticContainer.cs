...
namespace Global
{
    ...
    public class StaticContainer : IDCLPlugin<StaticSettings>
    {
            ...
            bool enableGPUInstancing = true)
        {
            ...
            container.EmotesContainer = new EmotesContainer(assetsProvisioner, realmData);
