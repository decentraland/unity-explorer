...
namespace SceneRuntime.Tests
{
    public class SceneRuntimeShould
    {
        ...
        {
            return WebJsSources.WrapInModuleCommonJs(Encoding.UTF8.GetBytes(code));
        }
        ...
        public IEnumerator EngineApi_GetState() =>
            UniTask.ToCoroutine(async () =>
            {
                ...
                var sceneRuntime = await sceneRuntimeFactory.CreateBySourceCodeAsync(
        ...
        public IEnumerator EngineApi_TestRealScene() =>
            UniTask.ToCoroutine(async () =>
            {
                ...
                var sceneRuntime = await sceneRuntimeFactory.CreateByPathAsync(path, new SceneShortInfo(), CancellationToken.None);
