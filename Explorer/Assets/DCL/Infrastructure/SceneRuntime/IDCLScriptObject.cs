...
namespace SceneRuntime
{
    public interface IDCLScriptObject
    {
        ...
        /// <summary>
        ///     Gets the native JavaScript object representation.
        ///     This allows adapters to unwrap themselves to return the platform-specific native object
        ///     that JavaScript can properly enumerate and interact with.
        /// </summary>
        /// <returns>The native JavaScript object (e.g., ScriptObject for V8, WebGLScriptObject for WebGL).</returns>
