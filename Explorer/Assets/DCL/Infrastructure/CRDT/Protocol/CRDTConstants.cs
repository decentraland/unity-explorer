namespace CRDT.Protocol
{
    ...
    public static class CRDTConstants
    {
        ...
        public const int CRDT_AUTHORITATIVE_PUT_COMPONENT_HEADER_LENGTH = 16; // Same as PUT_COMPONENT
        ...
        public const int CRDT_AUTHORITATIVE_PUT_COMPONENT_BASE_LENGTH = MESSAGE_HEADER_LENGTH + CRDT_AUTHORITATIVE_PUT_COMPONENT_HEADER_LENGTH;
    }
}
