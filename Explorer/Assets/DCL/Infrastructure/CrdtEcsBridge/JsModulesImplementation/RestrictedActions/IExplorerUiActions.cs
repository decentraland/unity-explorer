...
namespace DCL.CrdtEcsBridge.JsModulesImplementation
{
    public interface IExplorerUiActions
    {
        ...
        ///     <paramref name="requestId" /> is echoed on those events so a scene with several calls in flight
        ///     can tell them apart; 0 is the protocol's value for a request that asked for no correlation.
