...
namespace CrdtEcsBridge.RestrictedActions.Tests
{
    ...
    public class GlobalWorldActionsShould
    {
        ...
        private class MockEmotesMessageBus : IEmotesMessageBus
        {
            ...
            public void Send(URN urn, bool loopCyclePassed, bool isUsingSocialEmoteOutcome, int socialEmoteOutcomeIndex, bool isReactingToSocialEmote, string socialEmoteInitiatorWalletAddress, bool isStopping, int interactionId) // Parameter name from interface
            {
