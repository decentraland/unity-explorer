...
namespace DCL.WebRequests.RequestsHub
{
    public class RequestHub : IRequestHub
    {
        ...
        public RequestHub(IDecentralandUrlsSource urlsSource, HTTPCache cache, bool partialDownloadingEnabled, long chunkSize, byte maxChunksCount,
            bool ktxEnabled,
            WebRequestsMode mode)
        {
            ...
            Add(mutableMap, (IWebRequestController controller, in RequestEnvelope envelope, in PartialDownloadArguments args) => new PartialDownloadRequest(cache, envelope, args, controller, chunkSize, maxChunksCount, partialDownloadingEnabled, mode));
        }
