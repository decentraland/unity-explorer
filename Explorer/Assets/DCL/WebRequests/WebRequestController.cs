...
namespace DCL.WebRequests
{
    public class WebRequestController : IWebRequestController
    {
        ...
        private static readonly InitializeRequest<GenericHeadArguments, GenericHeadRequest> HEAD_GENERIC =
            GenericHeadRequest.Initialize;
        ...
        public UniTask<GenericHeadRequest> HeadAsync(
            ...
            WebRequestSignInfo? signInfo = null)
        {
            return SendAsync(HEAD_GENERIC, commonArguments, arguments, ct, reportCategory, headersInfo, signInfo);
        }
