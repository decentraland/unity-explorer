namespace DCL.NotificationsBusController.NotificationTypes
{
    public enum NotificationType
    {
        ...
        SOCIAL_SERVICE_COMMUNITY_EVENT_CREATED,
        SOCIAL_SERVICE_COMMUNITY_EVENT_ABOUT_TO_START,
        SOCIAL_SERVICE_COMMUNITY_USER_REMOVED,
        SOCIAL_SERVICE_COMMUNITY_USER_BANNED,
        SOCIAL_SERVICE_COMMUNITY_RENAMED,
        SOCIAL_SERVICE_COMMUNITY_DELETED,
