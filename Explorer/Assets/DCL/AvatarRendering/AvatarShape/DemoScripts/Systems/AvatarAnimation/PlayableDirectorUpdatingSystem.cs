    ...
    public partial class PlayableDirectorUpdatingSystem : BaseUnityLoopSystem
    {
        ...
        protected override void Update(float t)
        {
            ...
            if (playableDirector != null)
            {
                ...
                else { ReportHub.LogError(ReportCategory.DEBUG, "The update mode of the PlayableDirector (component that plays a timeline) must be Manual for the system to animate the avatar properly."); }
            }
        }
    }
}
