...
namespace DCL.AvatarRendering.AvatarShape.Rendering.TextureArray
{
    public static class TextureArrayContainerFactory
    {
        ...
        internal static TextureArrayContainer CreatePBR(Texture defaultTexture)
        {
            return new TextureArrayContainer (
                new TextureArrayMapping[]
                {
                    new (new TextureArrayHandler(MAIN_TEXTURE_ARRAY_SIZE, BASE_MAP_ARR_SHADER_INDEX, BASE_MAP_ARR_TEX_SHADER, MAIN_TEXTURE_RESOLUTION, DEFAULT_BASEMAP_TEXTURE_FORMAT, defaultTexture), BASE_MAP_ORIGINAL_TEXTURE)
                });
        }
        ...
        internal static TextureArrayContainer CreateToon(int customResolution, Texture defaultMain, Texture defaultNormal, Texture defaultEmmissive)
        {
            return new TextureArrayContainer (
                new TextureArrayMapping[]
                {
                    ...
                    new (new TextureArrayHandler(NORMAL_TEXTURE_ARRAY_SIZE, NORMAL_MAP_ARR_SHADER_INDEX, NORMAL_MAP_ARR_TEX_SHADER, customResolution, DEFAULT_NORMALMAP_TEXTURE_FORMAT, defaultNormal),
                        BUMP_MAP_ORIGINAL_TEXTURE_ID),
                    new (new TextureArrayHandler(EMISSION_TEXTURE_ARRAY_SIZE, EMISSIVE_TEX_ARR_SHADER_INDEX, EMISSIVE_TEX_ARR_TEX_SHADER, customResolution, DEFAULT_EMISSIVEMAP_TEXTURE_FORMAT, defaultEmmissive),
        ...
        public static TextureArrayContainer Create(Shader shader, int resolution, Dictionary<string, Texture> defaultTextures)
        {
            return shader.name switch
            {
                ...
                _ => CreatePBR( defaultTextures[$"Main_{resolution}"])
            };
        }
