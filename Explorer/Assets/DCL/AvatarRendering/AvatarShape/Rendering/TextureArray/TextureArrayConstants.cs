...
namespace DCL.AvatarRendering.AvatarShape.Rendering.TextureArray
{
    public static class TextureArrayConstants
    {
        ...
        public const TextureFormat DEFAULT_METALLICGLOSSMAP_TEXTURE_FORMAT = TextureFormat.BC7;
        ...
        public const int METALLICGLOSS_TEXTURE_ARRAY_SIZE = 75;
        ...
        public const int METALLICGLOSS_TEXTURE_RESOLUTION = 512;
        ...
        public static readonly int MAINTEX_TEX_ARR_INDEX = Shader.PropertyToID("_MainTexArr_ID");
        public static readonly int MAINTEX_TEX_ARR = Shader.PropertyToID("_MainTexArr");
        ...
        public static readonly int NORMAL_MAP_ORIGINAL_TEXTURE = Shader.PropertyToID("_NormalMap");
        ...
        public static readonly int BUMP_MAP_ORIGINAL_TEXTURE = Shader.PropertyToID("_BumpMap");
        public static readonly int BUMP_MAP_TEX_ARR_INDEX = Shader.PropertyToID("_BumpMapArr_ID");
        public static readonly int BUMP_MAP_TEX_ARR = Shader.PropertyToID("_BumpMapArr");

        public static readonly int EMISSIVE_TEX_ORIGINAL_TEXTURE = Shader.PropertyToID("_Emissive_Tex");
        ...
        public static readonly int EMISSION_MAP_ORIGINAL_TEXTURE = Shader.PropertyToID("_EmissionMap");
        public static readonly int EMISSION_MAP_TEX_ARR_INDEX = Shader.PropertyToID("_EmissionMapArr_ID");
        public static readonly int EMISSION_MAP_TEX_ARR = Shader.PropertyToID("_EmissionMapArr");

        public static readonly int METALLIC_GLOSS_MAP_ORIGINAL_TEXTURE = Shader.PropertyToID("_MetallicGlossMap");
        public static readonly int METALLIC_GLOSS_MAP_TEX_ARR_INDEX = Shader.PropertyToID("_MetallicGlossMapArr_ID");
        public static readonly int METALLIC_GLOSS_MAP_TEX_ARR = Shader.PropertyToID("_MetallicGlossMapArr");

        public static readonly int MASK_ORIGINAL_TEXTURE = WearableTextureConstants.MASK_ORIGINAL_TEXTURE_ID;
        public static readonly int MASK_TEX_ARR_INDEX = Shader.PropertyToID("_MaskTexArr_ID");
        public static readonly int MASK_TEX_ARR = Shader.PropertyToID("_MaskTexArr");
    }
}
