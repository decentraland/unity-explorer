#ifndef AVATAR_BRDF_DATA_INCLUDED
#define AVATAR_BRDF_DATA_INCLUDED

#include "Avatar_CelShading_BSDF.hlsl"
...
inline void InitializeBRDFDataDirect(half3 albedo, half3 diffuse, half3 specular, half reflectivity, half oneMinusReflectivity, half smoothness, inout half alpha, out BRDFData_Avatar outBRDFData)
{
    outBRDFData = (BRDFData_Avatar)0;
...
inline void InitializeBRDFDataDirect(half3 diffuse, half3 specular, half reflectivity, half oneMinusReflectivity, half smoothness, inout half alpha, out BRDFData_Avatar outBRDFData)
{
...
inline void InitializeBRDFData(half3 albedo, half metallic, half3 specular, half smoothness, inout half alpha, out BRDFData_Avatar outBRDFData)
{
...
inline void InitializeBRDFDataClearCoat(half clearCoatMask, half clearCoatSmoothness, inout BRDFData_Avatar baseBRDFData, out BRDFData_Avatar outBRDFData)
{
    outBRDFData = (BRDFData_Avatar)0;
...
BRDFData_Avatar CreateClearCoatBRDFData(SurfaceData_Avatar surfaceData, inout BRDFData_Avatar brdfData)
{
...
half3 EnvironmentBRDFClearCoat(BRDFData_Avatar brdfData, half clearCoatMask, half3 indirectSpecular, half fresnelTerm)
{
    float surfaceReduction = 1.0 / (brdfData.roughness2 + 1.0);
...
half DirectBRDFSpecular(BRDFData_Avatar brdfData, half3 normalWS, half3 lightDirectionWS, half3 viewDirectionWS)
{
...
half3 DirectBDRF(BRDFData_Avatar brdfData, half3 normalWS, half3 lightDirectionWS, half3 viewDirectionWS, bool specularHighlightsOff)
{
...
// * Modified Kelemen and Szirmay-Kalos for Visibility term
// * Fresnel approximated with 1/LdotH
half3 DirectBRDF(BRDFData_Avatar brdfData, half3 normalWS, half3 lightDirectionWS, half3 viewDirectionWS)
{
