#ifndef AVATAR_REALTIME_LIGHTS_INCLUDED
#define AVATAR_REALTIME_LIGHTS_INCLUDED
...
#include "LightCookie/Avatar_CelShading_LightCookie.hlsl"
#include "Avatar_CelShading_Clustering.hlsl"
...
Light GetMainLight(InputData_Avatar inputData, half4 shadowMask, AmbientOcclusionFactor aoFactor)
{
...
Light GetAdditionalLight(uint i, InputData_Avatar inputData, half4 shadowMask, AmbientOcclusionFactor aoFactor)
{
...
half4 CalculateShadowMask(InputData_Avatar inputData)
{
