#ifndef AVATAR_GLOBAL_ILLUMINATION_INCLUDED
#define AVATAR_GLOBAL_ILLUMINATION_INCLUDED

#include "Avatar_CelShading_EntityLighting.hlsl"
#include "Avatar_CelShading_ImageBasedLighting.hlsl"
...
half3 GlobalIllumination(BRDFData_Avatar brdfData, BRDFData_Avatar brdfDataClearCoat, float clearCoatMask,
...
half3 GlobalIllumination(BRDFData_Avatar brdfData, half3 bakedGI, half occlusion, float3 positionWS, half3 normalWS, half3 viewDirectionWS)
{
...
half3 GlobalIllumination(BRDFData_Avatar brdfData, half3 bakedGI, half occlusion, half3 normalWS, half3 viewDirectionWS)
{
    const BRDFData_Avatar noClearCoat = (BRDFData_Avatar)0;
