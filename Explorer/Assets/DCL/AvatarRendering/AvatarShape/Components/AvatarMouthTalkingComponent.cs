namespace DCL.AvatarRendering.AvatarShape.Components
{
    ...
    ///     AvatarMouthAnimationSystem reads this to drive phoneme animation without requiring
    ...
    public struct AvatarMouthTalkingComponent
    {
        ...
        /// <summary>
        ///     True when a new, unconsumed message has arrived. Reset to false by AvatarMouthAnimationSystem.
        /// </summary>
        public bool IsDirty;
    }
}
