...
namespace DCL.AvatarRendering.Wearables.Helpers
{
    public partial class WearableStorage : IWearableStorage
    {
        ...
        private readonly Dictionary<URN, LinkedListNode<(URN key, long lastUsedFrame)>> cacheKeysDictionary = new (new Dictionary<URN, LinkedListNode<(URN key, long lastUsedFrame)>>(), URNCachedEqualityComparer.Default);
        private readonly Dictionary<URN, Dictionary<URN, NftBlockchainOperationEntry>> ownedNftsRegistry = new (new Dictionary<URN, Dictionary<URN, NftBlockchainOperationEntry>>(), URNCachedEqualityComparer.Default);

        private readonly object lockObject = new ();

        internal Dictionary<URN, IWearable> wearablesCache { get; } = new (new Dictionary<URN, IWearable>(), URNCachedEqualityComparer.Default);
