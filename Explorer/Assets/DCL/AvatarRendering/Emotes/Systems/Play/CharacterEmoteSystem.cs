            ...
            in IAvatarView avatarView, ref AvatarShapeComponent avatarShapeComponent)
        {
            ...
            try
            {
                ...
                if (emoteStorage.TryGetElement(emoteId.Shorten(), out IEmote emote))
                {
                    ...
                    if (!emotePlayer.Play(mainAsset, streamableAssetValue.Asset!.AnimationClips, audioClip, emote.IsLooping(), emoteIntent.Spatial, in avatarView, ref emoteComponent))
