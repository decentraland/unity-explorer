...
namespace DCL.AvatarRendering.Emotes
{
    ...
    public class SocialEmotesSettings : ScriptableObject
    {
        ...
        /// <summary>
        ///     The minimum distance between the initiator and the receiver for the interaction tooltips to appear in receiver's
        ///     client.
        /// </summary>
        ...
        /// <summary>
        ///     The minimum distance between the initiator and the receiver for receiver to interpolate its position / rotation to
        ///     the first pose of the outcome animation.
        /// </summary>
        ...
        /// <summary>
        ///     The duration of the interpolation of the camera when initiating or finishing the reaction to a social emote, in
        ///     seconds.
        /// </summary>
        ...
        /// <summary>
        ///     The maximum amount of time, in seconds, an avatar can be walking towards the initiator of a social emote. Once it
        ///     times out, the reaction is cancelled.
        /// </summary>
