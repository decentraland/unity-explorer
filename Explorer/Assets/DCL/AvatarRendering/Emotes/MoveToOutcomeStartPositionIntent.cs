...
{
    /// <summary>
    ///     Component added when an avatar is reacting to a social emote and is close enough to the other so it can start
    ///     playing the emote. The avatar will be smoothly moved
    ///     to the position the avatar will be at when the outcome animation of the social emote starts. While the avatar is
    ///     moving, the CharacterController stays where it was.
    /// </summary>
    public struct InterpolateToOutcomeStartPoseIntent
    {
        ...
        /// <summary>
        ///     Set when the interpolation has to be stopped. An avatar may have moved, jumped or there is any situation that
        ///     cancels the emote.
        /// </summary>
