...
{
    [CreateAssetMenu(fileName = "PlaceContextMenuConfiguration", menuName = "DCL/Places/ContextMenuSettings")]
    public class PlaceContextMenuConfiguration : ScriptableObject
    {
