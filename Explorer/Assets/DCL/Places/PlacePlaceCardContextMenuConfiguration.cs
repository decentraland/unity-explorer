...
{
    [CreateAssetMenu(fileName = "PlaceCardContextMenuSettings", menuName = "DCL/Places/ContextMenuSettings")]
    public class PlacePlaceCardContextMenuConfiguration : ScriptableObject
    {
