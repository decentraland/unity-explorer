...
{
    // Attaches the UUAV facade component and forwards to it, converting
    // between the facade's types and this layer's structurally identical
    // ones. Also serves as the polled control/info/texture surface the
    // consumer reaches through MediaPlayer.Control / .Info / .TextureProducer.
    public sealed class UuavBackend
    {
        ...
        // The facade builds its control and texture surfaces in Awake,
        ...
        // Pauses and seeks back to the start; the media stays open so a later
        // Play resumes from zero.
