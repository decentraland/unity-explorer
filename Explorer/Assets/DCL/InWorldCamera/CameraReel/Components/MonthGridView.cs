...
namespace DCL.InWorldCamera.CameraReel.Components
{
    public class MonthGridView : MonoBehaviour
    {
        ...
        public void Setup(DateTime bucket, List<CameraReelResponse> images, ReelThumbnailPoolManager reelThumbnailPool)
        {
            ...
            for (int i = 0; i < images.Count; i++)
                reelThumbnailViews.Add(reelThumbnailPoolManager.Get(images[i], this));
        }
