...
namespace DCL.MainPlayerTriggerArea
{
    ...
    [ThrottlingEnabled]
    public partial class MainPlayerTriggerAreaHandlerSystem : BaseUnityLoopSystem
    {
        ...
        {
            SetupMainPlayerTriggerAreaQuery(World);
        }

        [Query]
        private void SetupMainPlayerTriggerArea(ref TransformComponent transformComponent, ref MainPlayerTriggerAreaComponent mainPlayerTriggerAreaComponent)
        {
