...
namespace DCL.Chat.ChatReactions
{
    ...
    public interface ISituationalReactionService
    {
        ...
        /// <summary>Spawn a burst with a random emoji and default count, rising from the lane bottom.</summary>
        void TriggerDefaultUIReaction();

        /// <summary>Spawn a burst with a random emoji and default count, rising from a specific UI rect.</summary>
