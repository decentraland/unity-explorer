...
namespace DCL.PerformanceAndDiagnostics.Analytics
{
    ...
    public class AnalyticsContainer : DCLGlobalContainer<AnalyticsContainer.Settings>
    {
        ...
        internal static IAnalyticsService CreateAnalyticsService(AnalyticsConfiguration analyticsConfig, LauncherTraits launcherTraits, IAppArgs args, bool isLocalSceneDevelopment, IEventBus eventBus, CancellationToken token)
        {
