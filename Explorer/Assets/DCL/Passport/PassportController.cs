...
namespace DCL.Passport
{
    public partial class PassportController : ControllerBase<PassportView, PassportController.Params>
    {
        ...
        protected override void OnViewInstantiated()
        {
            ...
            cameraReelGalleryController = new CameraReelGalleryController(viewInstance.CameraReelGalleryModuleView, cameraReelStorageService,cameraReelScreenshotsStorage, gridLayoutFixedColumnCount, thumbnailHeight, thumbnailWidth, false);
