...
namespace DCL.Rendering.Highlight
{
    ...
    public partial class HighlightRendererFeature : ScriptableRendererFeature
    {
        ...
        {
            // Highlight Input
            if (highlightInputMaterial && m_ShaderHighlightInput && highlightRTHandle_Colour != null) { _renderer.EnqueuePass(highlightInputRenderPass); }

            // HighLight Output
            if (highlightOutputMaterial && m_ShaderHighlightOutput) { _renderer.EnqueuePass(highlightOutputRenderPass); }
        }
