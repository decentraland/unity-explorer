...
//         public NativeArray<Grass_BRG.GrassData> _backgroundItems;
//
//         [ReadOnly]
//         [NativeDisableParallelForRestriction]
...
//                 Grass_BRG.GrassData cell = _backgroundItems[cellIndex];
...
//                 Grass_BRG.GrassData cell = _backgroundItems[item.groundCell];
...
//                     Grass_BRG.GrassData cell = _backgroundItems[cellId];
...
//     }
//
//     public JobHandle AddPhysicsUpdateJob(NativeArray<Grass_BRG.GrassData> backgroundItems, int sliceId, uint w, uint h, float dt, float zDisplacement, float smoothScrollingPos)
//     {
//
