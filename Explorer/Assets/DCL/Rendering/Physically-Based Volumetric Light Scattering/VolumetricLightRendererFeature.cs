...
{
    internal class VolumetricLightRendererFeature_Settings
    {
        // Parameters
    ...
    public partial class VolumetricLightRendererFeature : ScriptableRendererFeature
    {
        ...
        void Awake()
        {
            ...
            if (_spotLightMesh == null) { _spotLightMesh = CreateSpotLightMesh(); }
            ...
            if (_defaultSpotCookie == null) { _defaultSpotCookie = DefaultSpotCookie; }
        ...
        public void OnPreRender()
        {
            ...
            else { _preLightPass.SetRenderTarget(_volumeLightTexture); }
