...
namespace DCL.CharacterMotion.Settings
{
    ...
    public class CharacterControllerSettings : ScriptableObject, ICharacterControllerSettings
    {
        ...
        [field: SerializeField] [field: Header("IK")] public float FeetIKHipsPullMaxDistance { get; private set; } = 0.5f;
        [field: SerializeField] public float FeetIKSphereSize { get; private set; } = 0.15f;
        [field: SerializeField] public float IKWeightSpeed { get; private set; } = 2f;
        [field: SerializeField] public float IKPositionSpeed { get; private set; } = 1f;
