...
namespace DCL.Navmap
{
    public class FloatingPanelController : IDisposable
    {
        ...
        private void HideWithSlide()
        {
            ...
            view.rectTransform.DOLocalMove(rectTransformLocalPositionOutside, 0.5f).SetEase(Ease.Linear)
        ...
        private void TeleportToParcel(Vector2Int parcel)
        {
            async UniTaskVoid ShowLoadingAndTeleportAsync(CancellationToken ct)
            {
                ...
                await UniTask.WhenAll(mvcManager
                        .ShowAsync(SceneLoadingScreenController.IssueCommand(
                            new SceneLoadingScreenController.Params(loadReport!, timeout)))
