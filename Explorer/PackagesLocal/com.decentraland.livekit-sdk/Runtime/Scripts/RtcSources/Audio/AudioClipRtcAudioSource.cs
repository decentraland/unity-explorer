...
namespace LiveKit.Audio
{
    public class AudioClipRtcAudioSource : IRtcAudioSource
    {
        ...
        private readonly DclAudioFilter audioFilter;
            ...
            (AudioMixer audioMixer, string audioVolumeParameter)? audioMixerVolume = null)
        {
            ...
            audioSource.Play();
            DclAudioFilter filter = gm.AddComponent<DclAudioFilter>()!;
        ...
        public void Start()
        {
            ...
            {
                LiveKit.Internal.Utils.Error("DclAudioFilter or AudioSource is null - cannot start audio capture");
                return;
            }
