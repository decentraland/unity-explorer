...
namespace DCL.Rendering.RenderGraphs.RenderFeatures.Ocean
{
    ...
    public class PlanarReflectionRendererInspector : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (renderer.waterObjects.Count == 0 && OceanObject.Instances.Count == 1)
            {
                renderer.waterObjects.Add(OceanObject.Instances[0]);
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                {
                    renderer.waterObjects = new List<OceanObject>(OceanObject.Instances);
        ...
        private void ValidateWaterObjectLayer()
        {
            ...
            foreach (OceanObject obj in renderer.waterObjects)
            {
