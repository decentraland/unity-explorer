...
namespace DCL.Rendering.RenderGraphs.RenderFeatures.Ocean
{
    ...
    public class PlanarReflectionRenderer : MonoBehaviour
    {
        ...
        [SerializeField]
        public List<OceanObject> waterObjects = new List<OceanObject>();
        ...
        {
            waterObjects = new List<OceanObject>(OceanObject.Instances);
            RecalculateBounds();
...
#pragma warning restore 0618
        ...
        public void AddWaterObject(OceanObject waterObject)
        {
        ...
        /// </summary>
        /// <param name="waterObject"></param>
        public void RemoveWaterObject(OceanObject waterObject)
        {
        ...
        private void ToggleMaterialReflectionSampling(OceanObject waterObject, bool state)
        {
