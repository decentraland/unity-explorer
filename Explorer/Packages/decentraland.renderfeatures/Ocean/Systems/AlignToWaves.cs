...
namespace DCL.Rendering.RenderGraphs.RenderFeatures.Ocean
{
    ...
    public class AlignToWaves : MonoBehaviour
    {
        ...
        public OceanObject waterObject;
        ...
        private void Reset()
        {
            ...
            if (waterObject == null && OceanObject.Instances.Count > 0)
            {
                waterObject = OceanObject.Instances[0];
        ...
        public void FixedUpdate()
        {
            ...
            if(autoFind) waterObject = OceanObject.Find(this.transform.position, false);
