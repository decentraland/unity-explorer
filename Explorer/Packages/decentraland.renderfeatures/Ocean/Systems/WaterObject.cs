...
namespace DCL.Rendering.RenderGraphs.RenderFeatures.Ocean
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu("Ocean/Ocean Object")]
    [DisallowMultipleComponent]
    public class OceanObject : MonoBehaviour
    {
        /// <summary>
        /// Collection of all available OceanObject instances. Instances (un)register themselves in the OnEnable/OnDisable functions.
        /// </summary>
        public static readonly List<OceanObject> Instances = new List<OceanObject>();
        ...
        /// <returns></returns>
        public static OceanObject New(Material waterMaterial = null, Mesh mesh = null)
        {
            GameObject go = new GameObject("Water Object", typeof(MeshFilter), typeof(MeshRenderer), typeof(OceanObject));
            ...
            OceanObject waterObject = go.GetComponent<OceanObject>();
        ...
        /// <returns></returns>
        public static OceanObject Find(Vector3 position, bool rotationSupport)
        {
            Ray ray = new Ray(position + (Vector3.up * 1000f), Vector3.down);

            foreach (OceanObject obj in Instances)
            {
                if (rotationSupport)
                {
                    //Local space
