...
namespace UnityEditor.Rendering.DCL_Toon
{
    ...
    internal struct DCL_Toon_MaterialHeaderScope : IDisposable
    {
        ...
        private readonly bool spaceAtEnd;
        ...
        internal static bool DrawHeaderFoldout(GUIContent title, bool state, bool isBoxed = false, Func<bool> hasMoreOptions = null, Action toggleMoreOptions = null,
            string documentationURL = "", Action<Vector2> contextAction = null) =>
            EditorGUILayout.Foldout(state, title);
        ...
        internal DCL_Toon_MaterialHeaderScope(GUIContent title, uint bitExpanded, MaterialEditor materialEditor, bool spaceAtEnd = true, bool subHeader = false,
            uint defaultExpandedState = uint.MaxValue, string documentationURL = "")
        {
            ...
            {
                materialEditor.SetIsAreaExpanded(bitExpanded, expanded);
