...
namespace UnityEditor.Rendering.DCL_Toon
{
    ...
    internal class DCL_Toon_DocumentationInfo
    {
        ...
        private const string url = "https://docs.unity3d.com/Packages/{0}@{1}/manual/";
#else
        ...
        /// </summary>
        internal static string version => fallbackVersion;
        ...
        internal static string GetPageLink(string packageName, string pageName) =>
    ...
    internal static class DCL_Toon_DocumentationUtils
    {
        ...
        {
            Type type = mask.GetType();
            object[] attribute = type.GetCustomAttributes(typeof(HelpURLAttribute), false);
