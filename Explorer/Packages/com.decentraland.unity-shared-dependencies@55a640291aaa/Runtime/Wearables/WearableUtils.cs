    ...
    public static class WearableUtils
    {
            ...
            HashSet<string> combinedHidingList)
        {
            foreach (string category in WearableCategories.CATEGORIES_PRIORITY)
            {
                ...
                if (!TryGetNonEmptySet(hiddenCategoriesByCategory, category, out HashSet<string> hiddenList))
                    continue;
                ...
                foreach (string hiddenCategory in hiddenList)
                {
                    ...
                    if (!TryGetNonEmptySet(hiddenCategoriesByCategory, hiddenCategory, out HashSet<string> backList))
                        continue;
            ...
            if (forceRender != null)
            {
                foreach (HashSet<string> hiddenCategories in hiddenCategoriesByCategory.Values)
                {
            ...
            HashSet<string> combinedHidingList)
        {
            ...
            foreach (HashSet<string> hidingList in hiddenCategoriesByCategory.Values)
