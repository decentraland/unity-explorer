#ifndef AVATAR_LIGHTING_INCLUDED
#define AVATAR_LIGHTING_INCLUDED

#include "Avatar_CelShading_BRDF.hlsl"
//#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Debug/Debugging3D.hlsl"
#include "Avatar_CelShading_GlobalIllumination.hlsl"
#include "Avatar_CelShading_RealtimeLights.hlsl"
#include "Avatar_CelShading_AmbientOcclusion.hlsl"
...
half3 LightingPhysicallyBased(BRDFData_Avatar brdfData, BRDFData_Avatar brdfDataClearCoat,
...
half3 LightingPhysicallyBased(BRDFData_Avatar brdfData, BRDFData_Avatar brdfDataClearCoat, Light light, half3 normalWS, half3 viewDirectionWS, half clearCoatMask, bool specularHighlightsOff)
{
    return LightingPhysicallyBased(brdfData, brdfDataClearCoat, light.color, light.direction, light.distanceAttenuation * light.shadowAttenuation, normalWS, viewDirectionWS, clearCoatMask, specularHighlightsOff);
}

// Backwards compatibility
half3 LightingPhysicallyBased(BRDFData_Avatar brdfData, Light light, half3 normalWS, half3 viewDirectionWS)
{
...
#endif
    const BRDFData_Avatar noClearCoat = (BRDFData_Avatar)0;
    return LightingPhysicallyBased(brdfData, noClearCoat, light, normalWS, viewDirectionWS, 0.0, specularHighlightsOff);
}

half3 LightingPhysicallyBased(BRDFData_Avatar brdfData, half3 lightColor, half3 lightDirectionWS, half lightAttenuation, half3 normalWS, half3 viewDirectionWS)
{
    Light light;
...
half3 LightingPhysicallyBased(BRDFData_Avatar brdfData, Light light, half3 normalWS, half3 viewDirectionWS, bool specularHighlightsOff)
{
    const BRDFData_Avatar noClearCoat = (BRDFData_Avatar)0;
    return LightingPhysicallyBased(brdfData, noClearCoat, light, normalWS, viewDirectionWS, 0.0, specularHighlightsOff);
}

half3 LightingPhysicallyBased(BRDFData_Avatar brdfData, half3 lightColor, half3 lightDirectionWS, half lightAttenuation, half3 normalWS, half3 viewDirectionWS, bool specularHighlightsOff)
{
    Light light;
    light.color = lightColor;
    light.direction = lightDirectionWS;
...
LightingData CreateLightingData(InputData_Avatar inputData, SurfaceData_Avatar surfaceData)
{
...
half3 CalculateBlinnPhong(Light light, InputData_Avatar inputData, SurfaceData_Avatar surfaceData)
{
...
half4 UniversalFragmentPBR_Avatar(InputData_Avatar inputData, SurfaceData_Avatar surfaceData)
{
    ...
    BRDFData_Avatar brdfDataClearCoat = CreateClearCoatBRDFData(surfaceData, brdfData);
    ...
    lightingData.giColor = GlobalIllumination(brdfData, brdfDataClearCoat, 0.0f,
...
/// Phong lighting...
////////////////////////////////////////////////////////////////////////////////
half4 UniversalFragmentBlinnPhong(InputData_Avatar inputData, SurfaceData_Avatar surfaceData)
{
    #if defined(DEBUG_DISPLAY)
    half4 debugColor;
...
// Deprecated: Use the version which takes "SurfaceData" instead of passing all of these arguments...
half4 UniversalFragmentBlinnPhong(InputData_Avatar inputData, half3 diffuse, half4 specularGloss, half smoothness, half3 emission, half alpha, half3 normalTS)
{
    SurfaceData_Avatar surfaceData;
...
/// Unlit
////////////////////////////////////////////////////////////////////////////////
half4 UniversalFragmentBakedLit(InputData_Avatar inputData, SurfaceData_Avatar surfaceData)
{
    #if defined(DEBUG_DISPLAY)
    half4 debugColor;
...
// Deprecated: Use the version which takes "SurfaceData" instead of passing all of these arguments...
half4 UniversalFragmentBakedLit(InputData_Avatar inputData, half3 color, half alpha, half3 normalTS)
{
    SurfaceData_Avatar surfaceData;
